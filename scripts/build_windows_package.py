...
def build_nsis_installer(build_dir, exe_name):
    ...
    # Note: Qt 5 and Qt 6 have different directory structures
    qt_resources = [
        "generic",
        "iconengines",
        "imageformats",
...
def main():
    print("=== Windows package tool ===")

    parser = argparse.ArgumentParser(description="Package tool for Windows platform.")
    parser.add_argument(
